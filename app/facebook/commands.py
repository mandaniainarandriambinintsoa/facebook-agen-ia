...
class CommandRouter:
    """
    Routeur de commandes pour le chatbot Messenger.
    ...
    async def handle(self, sender_id: str, input_text: str) -> bool:
        ...
        # Normaliser: verifier si c'est un payload connu ou une commande texte
        payload = input_text.strip()

        # Verifier si c'est une commande texte
    ...
    async def _handle_get_started(self, sender_id: str):
        """Message de bienvenue enrichi avec quick replies"""
    ...
    async def _handle_products(self, sender_id: str):
        """Affiche le carousel des produits depuis la DB"""
        try:
            ...
            # Construire les elements du carousel
            elements = []
            ...
            # Ajouter des quick replies pour la navigation
    ...
    async def _handle_agent(self, sender_id: str):
        """Message d'escalation vers un agent humain"""
        contact_parts = []
    ...
    async def _handle_order_product(self, sender_id: str, product_id: str):
        """Detail commande pour un produit specifique"""
        try:
            import uuid
