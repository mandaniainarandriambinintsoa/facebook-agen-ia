...
export function FAQ() {
  ...
  return (
    <section id="faq" className="py-24 md:py-36 bg-[#F4ECE0]">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="grid md:grid-cols-12 gap-10 md:gap-20">
          ...
          <div className="md:col-span-4">
            <div className="md:sticky md:top-32">
              ...
              <h2 className="font-display text-4xl md:text-5xl text-[#0F0E0C] tracking-[-0.02em] leading-[1.05]">
                Avant de{" "}
                <em className="not-italic font-display italic text-[#B7481E]">tester</em>
                <span className="text-[#B7481E]">.</span>
              </h2>
              <p className="mt-6 text-[#0F0E0C]/70 leading-relaxed">
                Tout ce que tu te demandes probablement. Si une question manque,{" "}
                <a
                  href="mailto:contact@manda-ia.com"
                  className="underline underline-offset-4 decoration-[#B7481E] decoration-2 text-[#0F0E0C] font-medium"
                >
                  écris-nous
                </a>
                .
          ...
          {/* Right: questions */}
          <div className="md:col-span-8 divide-y divide-[#0F0E0C]/15 border-y border-[#0F0E0C]/15">
            {QUESTIONS.map((item, i) => {
              ...
              return (
                <article key={i}>
                  ...
                  >
                    <span className="font-mono text-[10px] text-[#B7481E] uppercase tracking-[0.2em] pt-2 shrink-0">
                      {String(i + 1).padStart(2, "0")}
                    </span>
                    <span className="font-display text-xl md:text-[1.625rem] text-[#0F0E0C] flex-1 leading-tight tracking-[-0.01em] group-hover:text-[#B7481E] transition-colors">
                      {item.q}
                    </span>
                    <span
                      className={`mt-1.5 inline-flex h-7 w-7 items-center justify-center rounded-full border border-[#0F0E0C]/30 text-[#0F0E0C] shrink-0 transition-all duration-300 ${
                        isOpen ? "rotate-45 bg-[#0F0E0C] text-[#FAF9F5] border-[#0F0E0C]" : ""
                      }`}
                    >
                  ...
                  >
                    <div className="overflow-hidden">
                      <p className="text-[#0F0E0C]/75 leading-relaxed pl-12 max-w-2xl">
                        {item.a}
                      </p>
                    </div>
                  </div>
