...
export function Features() {
  return (
    <section className="py-24 md:py-36 bg-[#1C1E21] text-[#F7F8FA] relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="grid md:grid-cols-12 gap-8 mb-20">
          <div className="md:col-span-7">
            ...
            <h2 className="text-4xl md:text-6xl tracking-[-0.02em] leading-[1.0]">
              Tout ce qu&apos;il te faut.
              <br />
              <em className="not-italic italic text-[#F4B83A]">Rien de plus</em>
              <span className="text-[#F4B83A]">.</span>
            </h2>
          </div>
          <div className="md:col-span-5 md:pt-8">
            <p className="text-[#F7F8FA]/70 text-lg leading-relaxed">
        ...
        <div className="grid md:grid-cols-12 gap-5">
          {FEATURES.map((f, i) => {
            ...
            return (
              <article
                key={f.title}
                className={`${span} relative border border-[#F7F8FA]/12 rounded-2xl p-6 md:p-8 hover:border-[#F4B83A]/50 hover:bg-[#F7F8FA]/[0.025] transition-all duration-300`}
              >
                ...
                <p className="text-[#F7F8FA]/70 text-sm leading-relaxed">{f.desc}</p>
              </article>
            );
          })}
        </div>
