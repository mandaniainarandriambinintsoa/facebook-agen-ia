...
export function Step1Welcome({ pageName, onNext, onSkip }: Step1Props) {
  return (
    <div className="max-w-2xl mx-auto text-center">
      ...
      <p className="text-lg text-[#1C1E21]/70 leading-relaxed mb-10 max-w-xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        <button
          onClick={onSkip}
          className="text-[#1C1E21]/60 hover:text-[#1C1E21] underline underline-offset-4 decoration-[#1C1E21]/30 text-sm transition-colors"
        >
