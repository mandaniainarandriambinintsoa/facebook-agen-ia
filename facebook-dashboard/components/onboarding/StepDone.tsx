  ...
  return (
    <div className="max-w-3xl mx-auto text-center relative">
      ...
      <div className="relative">
        <div className="inline-flex h-20 w-20 items-center justify-center rounded-full bg-[#2D4A3E] text-[#FBF6EE] mb-8">
        ...
        <p className="text-lg text-[#1A1614]/70 leading-relaxed mb-12 max-w-xl mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-10">
          {NEXT_ACTIONS.map((a) => (
            <Link
              key={a.href}
              href={a.href}
              className="group text-left p-5 rounded-2xl border border-[#1A1614]/10 bg-[#FBF6EE]/50 hover:border-[#B7481E]/40 hover:bg-[#FBF6EE] transition-all"
            >
              <a.icon className="h-5 w-5 text-[#B7481E] mb-3" />
              <h3 className="font-display text-base text-[#1A1614] mb-1 leading-tight">
                {a.label}
              </h3>
              <p className="text-xs text-[#1A1614]/60 leading-relaxed">{a.desc}</p>
            </Link>
          ))}
        </div>
        ...
        <Link
          href="/dashboard"
          className="group inline-flex items-center gap-3 rounded-full bg-[#1A1614] text-[#FBF6EE] pl-7 pr-2 py-2.5 text-base font-medium hover:bg-[#B7481E] transition-all"
        >
          Aller au dashboard
